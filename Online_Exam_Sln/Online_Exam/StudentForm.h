...
namespace Online_Exam
{
	...
	public ref class StudentForm : public System::Windows::Forms::Form
	{
		...
		private:
			System::Windows::Forms::Button^  btnEditProfileStudent;

		private:
			System::Windows::Forms::Button^  btnPastTests;
		private:
			System::Windows::Forms::Button^  btnUnenroll;

		private:
			System::Windows::Forms::Button^  btnUpcomingTests;
		private:
			System::Windows::Forms::Button^  btnMyProfileStudent;
		private:
		...
		private:
			System::Windows::Forms::Button^  btnCertificates;
		private:
		...
		private:
			...
			#pragma endregion
		private:
			System::Void btnEditProfileStudent_Click(System::Object^  sender, System::EventArgs^  e)
			{
		...
		private:
			System::Void btnMyProfileStudent_Click(System::Object^  sender, System::EventArgs^  e)
			{
				contentPanel->Controls->Clear();
		...
		private:
			System::Void btnUpcomingTests_Click(System::Object^  sender, System::EventArgs^  e)
			{
				contentPanel->Controls->Clear();
		...
		private:
			System::Void btnPastTests_Click(System::Object^  sender, System::EventArgs^  e)
			{
				contentPanel->Controls->Clear();
			}
		private:
			System::Void btnUnenroll_Click(System::Object^  sender, System::EventArgs^  e)
			{
				contentPanel->Controls->Clear();
		...
		private:
			System::Void contentPanel_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e)
			{
			}
		private:
